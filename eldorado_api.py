...
GAME_LOOKUP = {
    ...
    "dragon ball legends": {"game_id": "130", "trade_environment_id": "0"},
    "pokemon tcg pocket": {"game_id": "226", "trade_environment_id": None},
    "watcher of realms": {"game_id": "325", "trade_environment_id": None},
    # Add a new entry here every time you capture a new game's real request
    # (Network tab, filter "flexibleOffers", create one real listing, look
    # at the "account" request's Payload tab).
}
